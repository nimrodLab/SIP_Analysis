...
n_epoch = int(1e3)  # nombre de répétitions sur tous les data
...
for arc, hidden_size in architectures.items():
    ...
    NC = [1] + hidden_size["CVNN"] + [3]
    N0 = NC[0]  # RVNN has 1x the inputs (inputs are real coordinates x, y)
    NL = 2 * NC[-1]  # output of CVNN is complex (PNP)
